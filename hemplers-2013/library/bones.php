...
function bones_scripts_and_styles() {
  if (!is_admin()) {
    ...
    wp_register_script( 'jquery-rumble', get_stylesheet_directory_uri() . '/library/js/libs/jquery.jrumble.1.3.min.js', array( 'jquery' ), '', true );
    ...
    */
    ...
    wp_enqueue_script( 'jquery-rumble' );
...
function bones_theme_support() {
	...
	// default thumb size
	set_post_thumbnail_size(148, 100, true);
