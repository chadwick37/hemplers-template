      ...
      <div id="blog_selector" class="clearfix">
        ...
        <div class="wptiles clearfix">
            ...
            if ( function_exists ( 'the_wp_tiles' ) ) {
              echo do_shortcode('[wp-tiles full_width post_type="post" orderby="date" order="DESC" grid="AABBC|AACDD|DEEGG|FF.GG|AABBC|AACDD|DEEGG|FF.GG" posts_per_page=10 pagination="ajax" byline_height="60%" byline_height_auto=true ]');
            }
            else {
